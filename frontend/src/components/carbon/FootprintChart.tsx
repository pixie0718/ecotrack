  ...
  return (
    <Card>
      <CardHeader>
        ...
        <p className="text-sm text-carbon-500">kg CO₂e per month</p>
      </CardHeader>
...
export const CategoryPieChart: React.FC<CategoryPieProps> = ({ data }) => {
  ...
  if (chartData.length === 0) {
    return (
      <Card>
        ...
        <div className="h-48 flex items-center justify-center text-carbon-400 text-sm">
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Category Breakdown</CardTitle>
        <p className="text-sm text-carbon-500">This month's emissions by source</p>
      </CardHeader>
      <ResponsiveContainer width="100%" height={250}>
        <PieChart>
          <Pie
