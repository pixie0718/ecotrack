  ...
  const addItem = () => {
    ...
    setItems((prev) => [
      ...prev,
      {
        ...
        key: activityKey,
        quantity: qty,
        co2: qty * selectedActivity.factor,
      },
    ]);
    setQuantity('');
  };
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <button
                onClick={() => setItems([])}
                className="text-sm text-carbon-400 hover:text-carbon-600 flex items-center gap-1"
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="text-carbon-300 hover:text-red-400 text-xs ml-2"
                    >
                      ✕
                    </button>
                  </div>
          ...
          <div className="border-t border-carbon-200 pt-4">
            <div className="flex justify-between items-center mb-2">
              <span className="font-semibold text-carbon-900">Total CO₂e</span>
              <span className="text-xl font-bold text-carbon-900">{formatCO2(totalCO2)}</span>
            </div>
            <div className="flex items-center gap-2 text-sm text-green-600">
              <Leaf className="h-4 w-4" />
              <span>≈ {treeEquivalent.toFixed(1)} trees needed to offset this for 1 year</span>
            </div>
            <div className="mt-3 text-xs text-carbon-400">
