    ...
    <div className="space-y-6 max-w-2xl">
      <div>
        <h1 className="text-2xl font-bold text-carbon-900 dark:text-white flex items-center gap-2">
          <User className="h-6 w-6 text-carbon-600 dark:text-carbon-400" />
          Profile & Settings
        </h1>
      ...
      <Card>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm font-medium text-carbon-500 dark:text-carbon-400">Email</p>
            <p className="text-carbon-900 dark:text-white mt-1">{user?.email}</p>
          </div>
          {user?.firstName && (
            <div>
              <p className="text-sm font-medium text-carbon-500 dark:text-carbon-400">Name</p>
              <p className="text-carbon-900 dark:text-white mt-1">{user.firstName} {user.lastName}</p>
            </div>
          )}
          <div>
            <p className="text-sm font-medium text-carbon-500 dark:text-carbon-400">Member since</p>
            <p className="text-carbon-900 dark:text-white mt-1">
